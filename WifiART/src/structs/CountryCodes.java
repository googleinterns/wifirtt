...
public class CountryCodes {
    ...
    private static HashMap<String, String> getCountryNamesToCodesMap() {
        ...
        for (String[] countryNameAndCode : COUNTRIES_NAMES_AND_CODES) {
            String countryName = countryNameAndCode[0];
            String countryCode = countryNameAndCode[1];
            countryNamesToCodesMap.put(countryName, countryCode);
        }
        return countryNamesToCodesMap;
    }
